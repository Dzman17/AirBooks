...
insert into `air-books`.`account` values('manager@test.com', 'managerPass', 'Einrique', 'YoMama', 'm');
insert into `air-books`.`account` values('employee@test.com', 'employeePass', 'Steve', 'Jobs', 'e');
insert into `air-books`.`account` values('customer@test.com', 'customerPass', 'Harry', 'Grills', 'c');
insert into `air-books`.`flights` values();
insert into `air-books`.`flights` values(1, '1200-01-01 5:00:00', 'house', 10, 10, 300.00, 60, 0);
insert into `air-books`.`flights` values(2, '2023-09-05 16:30:00', 'Bloomington', 28, 7, 549.99, 120, 0);
#----------Creates Test Objects----------
